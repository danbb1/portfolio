...
Initially the plan was have a full catalogue of merch available to purchase, so the site was developed to integrate with Snipcart for a full-featured e-commerce solution. However, the amount of merch available was drastically scaled back and so Stripe was deemed suitable to manage the much smaller inventory _(At the time of writing, the merch had not been released and so was not live)_.
